...
namespace APBDKolokwium.Migrations
{
    ...
    [Migration("20240609175929_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBDKolokwium.Models.Client", b =>
                {
                    ...
                    b.ToTable("Client", "apbd");
                });

            modelBuilder.Entity("APBDKolokwium.Models.Discount", b =>
                {
                    ...
                    b.ToTable("Discount", "apbd");
                });

            modelBuilder.Entity("APBDKolokwium.Models.Payment", b =>
                {
                    ...
                    b.ToTable("Payment", "apbd");
                });

            modelBuilder.Entity("APBDKolokwium.Models.Sale", b =>
                {
            ...
            modelBuilder.Entity("APBDKolokwium.Models.Subscription", b =>
                {
                    b.Property<int>("IdSubscription")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Subscription", "apbd");
                });

            modelBuilder.Entity("APBDKolokwium.Models.Discount", b =>
                {
                    b.HasOne("APBDKolokwium.Models.Client", "Client")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("APBDKolokwium.Models.Payment", b =>
                {
                    ...
                    b.HasOne("APBDKolokwium.Models.Subscription", "Subscription")
                        .WithMany("Payments")
